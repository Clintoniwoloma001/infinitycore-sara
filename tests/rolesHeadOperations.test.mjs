...
assert.match(core, /BANKONE_QUERY_ROLES = \['super_admin', 'admin', 'hr_manager', 'hr_officer', 'head_of_operations', 'financial_controller'\]/)
...
assert.match(saraIntent, /TERMINATION_ROLES = \['super_admin', 'hr_manager'\]/, 'termination stays biometric')
