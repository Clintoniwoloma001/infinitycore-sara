      ...
      <div className="bg-white border border-slate-200 rounded-xl p-6">
        <div className="flex flex-col sm:flex-row sm:items-center gap-4 justify-between">
          ...
          <div className="flex gap-2 flex-wrap">
            ...
            {['super_admin', 'admin', 'head_of_human_resources'].includes(actualRole) && cand.application_status !== 'blacklisted' && <button onClick={blacklistCandidate} disabled={!!busy} className="inline-flex items-center gap-1.5 px-3 py-2 rounded-lg border border-rose-300 text-rose-700 text-xs font-medium hover:bg-rose-50 disabled:opacity-50"><ShieldBan className="w-3.5 h-3.5" /> Blacklist</button>}
