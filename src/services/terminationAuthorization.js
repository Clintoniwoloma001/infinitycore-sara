...
export const PERSONNEL_TERMINATION_ROLES = ['super_admin', 'hr_manager']

// Archive is a sensitive employee-lifecycle action and intentionally
// inherits the same restricted authorization model.
export const PERSONNEL_ARCHIVE_ROLES = ['super_admin', 'hr_manager']
...
// the same rule end-to-end. super_admin and hr_manager are the ONLY
